...
class PopulateDepositTogel implements ShouldQueue
{
    ...
    {
        DB::connection('togel')->table('depo')
        ...
        ->chunk(2000, function ($deposits) {
            foreach($deposits as $depo){
                ...
                $username = substr(strtolower($depo->username), 3);
...
Log::warning($depo->toBank);
                ...
                $amountSubmitted = ($depo->jumlah / 1000);
